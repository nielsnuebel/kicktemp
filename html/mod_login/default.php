	...
	<div class="userdata">
			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
                    <div class="input-group">
                        <span class="glyphicon glyphicon-user input-group-addon hasTooltip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"></span>
		...
		<div id="form-login-password" class="form-group">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
                    <div class="input-group">
						<span class="glyphicon glyphicon-lock input-group-addon hasTooltip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></span>
        ...
        <div class="list-group">
            ...
            <a href="<?php echo JRoute::_('index.php?option=com_users&view=registration&Itemid='.UsersHelperRoute::getRegistrationRoute()); ?>" class="list-group-item">
                <?php echo JText::_('MOD_LOGIN_REGISTER'); ?> <span class="icon-arrow-right"></span></a>
            <?php endif; ?>
            <a href="<?php echo JRoute::_('index.php?option=com_users&view=remind&Itemid='.UsersHelperRoute::getRemindRoute()); ?>" class="list-group-item">
                <?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_USERNAME'); ?></a>
            <a href="<?php echo JRoute::_('index.php?option=com_users&view=reset&Itemid='.UsersHelperRoute::getResetRoute()); ?>" class="list-group-item">
